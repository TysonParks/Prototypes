...
class Frame extends ProtoLayer {
  ...
  setBackGridGroup(mode = 0) {
    ...
    this.backGroup.createPerimiters('maxCorners', Direction.All)
    ...
    this.backGroup.shapesGroups.forEach(sg => {
      console.log(`svgGroup`, sg.svgGroup)
      sg.drawFilter = false
      sg.svgGroup.elt
  ...
  assignElement() {
    ...
    // this.sheetRect = createSVGElt('rect').id(`${this.id}-sheetRect`)
    //   .parent(this.bleedRect)
    //   .layout(-45, -10, 190, 220)
    ...
    // this.wrapFrame = createSVGElt().id(`${this.id}-wrapFrame`)
    //   .parent(this.svgElt)
    //   .addToClassList(this.id)
