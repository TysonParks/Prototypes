...
function gridTests2() {
  ...
  const shadeStack0 = Shade.neuShadeSVGFactory({ mag: minCellSize * -2 * 1.5 })
  ...
  let group000 = grid.squares({ coverage: 0.1, direction: Direction.DownRight, minSize: 2, uniform: false, overlapping: 'meh' })
  // grid.randGroup({amount:0.2})
