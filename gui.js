...
function keyPressed() {
  ...
  if (key === 'n') {
    ...
    // NOTE: This handler is also bound at the window level in
    // safariImageSwap.js for Safari focus robustness. The window-level
    // handler will fire first and call preventDefault, so p5 won't see
    // the event here on most paths — but this branch stays as a
